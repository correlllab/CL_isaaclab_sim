...
local ogn = get_ogn_project_information(ext, "cl/ros2/livox/lidar")
...
project_ext_plugin(ext, "cl.ros2.livox.lidar.plugin")
    cppdialect "C++17"

    add_files("include", "include/cl/ros2/livox/lidar")
    add_files("source", "plugins/cl.ros2.livox.lidar")
    add_files("nodes", ogn.nodes_path)
    includedirs {
        "include",
        "plugins/cl.ros2.livox.lidar",
