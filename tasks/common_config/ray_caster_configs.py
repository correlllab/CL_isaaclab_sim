...
class RayCasterBaseCfg:
    ...
    def get_ray_caster_cfg(
        ...
        return MultiMeshRayCasterCfg(
            ...
            prim_path=prim_path,
            debug_vis=True,
            mesh_prim_paths=["/World/GroundPlane", "/World/envs/env_0/Wall1/geometry/mesh", "/World/envs/env_0/Wall2/geometry/mesh", "/World/envs/env_0/Wall3/geometry/mesh", "/World/envs/env_0/Wall4/geometry/mesh", "/World/envs/env_0/PackingTable", "/World/envs/env_0/PackingTable2", "/World/envs/env_0/Red_block", "/World/envs/env_0/Yellow_block", "/World/envs/env_0/Green_block", "/World/envs/env_0/Pink_block", "/World/envs/env_0/Orange_block", "/World/envs/env_0/White_block"],
            ...
            ray_alignment="world",
            pattern_cfg=patterns.GridPatternCfg(resolution=0.02, size=(3.8 , 3.8), direction=(0, 0, -1)),
        )
